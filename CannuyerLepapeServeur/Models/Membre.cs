...
namespace CannuyerLepapeServeur.Models
{
    public class Membre
    {
        ...
        public Membre(string pseudo_membre, string mot_de_passe, string nom, string prenom, string mail, string telephone, string date_naissance, string ville, string pays, string rue, int code_postal, double argent, string date_inscription, bool administrateur)
        {
